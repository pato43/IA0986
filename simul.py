...
# Placeholder para continuar con la visualización y análisis en la parte 2...
# Visualizaciones avanzadas y funcionalidades interactivas para el dashboard
...
anomalies = filtered_data[filtered_data['Desviación'] > filtered_data['Desviación'].mean() + 2 * filtered_data['Desviación'].std()]
if anomalies.empty:
