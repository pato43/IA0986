...
def activar_modo_oscuro():
    ...
    st.markdown(dark_mode_style if modo_oscuro else light_mode_style, unsafe_allow_html=True)

# Integrar el interruptor en la función principal
def main():
    activar_modo_oscuro()  # Aplicar tema al inicio
    seleccionar_rol_usuario()  # Continuar con el flujo normal
